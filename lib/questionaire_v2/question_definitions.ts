...
export const answerSchemas = {
  ...
  drinksPerWeek: z
    ...
    .nonnegative()
    .max(1000)
    .describe("Number of standard alcohol drinks per week"),
  timesUsed: z
    .number()
    .int()
    .nonnegative()
    .max(10_000)
    .describe("Total number of times a substance was used"),
  seizures: z
    .number()
    .int()
    .nonnegative()
    .max(1000)
    .describe("Number of seizures in the last 12 months"),
  heightAndWeight: z
    .object({
      height_cm: z
        .number()
        ...
        .min(50)
        .max(300)
        .describe("Height in centimeters (50-300 cm)"),
      weight_kg: z
        .number()
        .positive()
        .min(20)
    ...
    .describe("Height and weight measurements for BMI calculation"),
  weightKg: z
    .number()
    .positive()
    .min(20)
...
export const QUESTIONS = new Map<string, QUESTION_TYPE>([
  ...
  [
    "Q2",
    {
      ...
      answer_type: answerSchemas.heightAndWeight, // Height in cm, weight in kg
  ...
  [
    "Q2PrePregnancyWeight",
    {
      ...
      answer_type: answerSchemas.weightKg, // Weight in kg
      resulting_nodes: ["Q3"],
  ...
  [
    "Q4q",
    {
      ...
      answer_type: answerSchemas.drinksPerWeek,
      resulting_nodes: ["Q5"],
  ...
  [
    "Q5freq",
    {
      ...
      answer_type: answerSchemas.number,
      resulting_nodes: ["Q6"],
      resulting_plans: [
        "Guaranteed+",
        "Deferred+",
  ...
  [
    "Q6when",
    {
      ...
      answer_type: answerSchemas.years,
  ...
  [
    "Q6howmany",
    {
      ...
      answer_type: answerSchemas.timesUsed,
      resulting_nodes: ["Q7"],
  ...
  [
    "Q17szCount",
    {
      ...
      answer_type: answerSchemas.seizures,

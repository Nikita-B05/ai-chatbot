...
export const QUESTION_DEPENDENCIES: Record<string, string[]> = {
  ...
  q3c: ["q3"], // Q3c (facility/assistance) is a sub-question after Q3 when not working
  q2_weightLoss: ["q2"],
  q2_pregnancy: ["q2"],
  q2_birth6m: ["q2_pregnancy"],
  q2_prePregWeight: ["q2_pregnancy"],
  q4q: ["q4"],
  q5mix: ["q5"],
  q5freq: ["q5"],
  q6when: ["q6"],
...
export const QUESTION_WORST_OUTCOME: Record<string, PlanOutcome | null> = {
  ...
  q1: null,
  q2: "Guaranteed+",
  q2_weightLoss: "Deferred+",
  q2_pregnancy: "Guaranteed+",
  q2_birth6m: "Guaranteed+",
  q2_prePregWeight: "Guaranteed+",
  q3: "Deferred+",
  q3c: "Guaranteed+",
  q4: "Guaranteed+",
  q4q: "Guaranteed+",
  ...
  q15sleep: "Guaranteed+",
  q15cpap: "Guaranteed+",
  q15asthma: "Guaranteed+",
  q15sev: "Guaranteed+",
  q16: "Deferred+",
  q16recent: "Deferred+",
  q16followup: "Deferred+",
  q17: "Guaranteed+",
  q17szonly: "Guaranteed+",
  q17count: "Guaranteed+",
  q17meds: "Guaranteed+",
  q18: "Guaranteed+",
  q18medscount: "Guaranteed+",
  q18moderate: "Guaranteed+",
  q19: "Guaranteed+",
  q19ibd: "Guaranteed+",
  q19fu: "Guaranteed+",
  q19sev: "Guaranteed+",
  ...
  q21prog: "Guaranteed+",
  q21amb: "Guaranteed+",
  q21attacks: "Guaranteed+",
  q22: "Guaranteed+",
  q22daily: "Guaranteed+",
  q22surgery: "Guaranteed+",
  q22meds: "Guaranteed+",
  q23: "Guaranteed+",
  q23hi: "Guaranteed+",
  q23mid: "Guaranteed+",
...
export const QUESTION_ORDER = [
  "q3", // Working
  "q3c", // Facility/assistance follow-up when not working
  "q4", // Alcohol
  "q4q",
  "q5", // Marijuana
  "q5mix",
